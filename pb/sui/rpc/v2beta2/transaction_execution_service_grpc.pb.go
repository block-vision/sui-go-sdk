...
const (
	TransactionExecutionService_ExecuteTransaction_FullMethodName = "/sui.rpc.v2beta2.TransactionExecutionService/ExecuteTransaction"
)
...
var TransactionExecutionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sui.rpc.v2beta2.TransactionExecutionService",
	...
	Metadata: "sui/rpc/v2beta2/transaction_execution_service.proto",
}
